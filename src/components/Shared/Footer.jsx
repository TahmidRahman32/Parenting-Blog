...
const Footer = () => {
   return (
      <div>
         <footer className="px-4 divide-y bg-[#30281c] text-gray-100">
            <div className="container  flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
               <div className="lg:w-1/3">
                  <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                     <div className="flex items-center justify-center w-12 h-12 rounded-full ">
                        <Image width={50} height={50} alt="footer image" src={footer}></Image>
                     </div>
                     <span className="self-center text-2xl font-primaryF">Parenting Blog</span>
                  </a>
               </div>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© Parenting Blog Company Co. All rights reserved.</div>
         </footer>
      </div>
   );
};
